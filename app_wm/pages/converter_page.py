#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Converter PDFs - SEM SCROLL. Log com scroll interno."""
...
class ConverterPage(QWidget):
    def __init__(self):
        ...
        icon_lbl = QLabel()
        icon_lbl.setPixmap(criar_icone_vetorial("pdf", 20, "#FFFFFF"))
        ...
        tc = QVBoxLayout()
        tc.setSpacing(1)
        t1 = QLabel("Converter PDFs")
        t1.setObjectName("FieldTitle")
        tc.addWidget(t1)
        t2 = QLabel("Extrai dados de PDFs do Relatório de Apoio à Apuração do ICMS e gera Excel agrupado.")
        ...
        self.path_input.setPlaceholderText("Clique para selecionar a pasta com PDFs de ICMS")
        ...
        icl.addWidget(acc5)
        ie = QLabel("EXTRAÇÃO"); ie.setObjectName("SectionEyebrow")
        icl.addWidget(ie)

        stats_info = [
            ("search", "PDFs encontrados",     "—", "#3B82F6"),
            ("pdf",    "Empresa detectada",     "—", "#F59E0B"),
            ("folder", "Períodos processados",  "—", "#8B5CF6"),
            ("link",   "Linhas extraídas",      "—", "#06B6D4"),
            ("chart",  "Arquivos Excel gerados", "—", "#00A651"),
        ]
        self._info_labels = {}
